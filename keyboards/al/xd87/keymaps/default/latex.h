const ucis_symbol_t ucis_symbol_table[] = UCIS_TABLE(
    ...
    UCIS_SYM("Lamda",   0x039B),                    // Λ
    UCIS_SYM("lamda",   0x03BB),                    // λ
    ...
    UCIS_SYM("Xi",      0x039E),                    // Ξ
    UCIS_SYM("xi",      0x03BE),                    // ξ
    UCIS_SYM("Psi",     0x03A8),                    // Ψ
